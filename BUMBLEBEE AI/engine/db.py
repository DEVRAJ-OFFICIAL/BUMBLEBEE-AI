...
# query = "INSERT INTO sys_command VALUES (null , 'file explorer' , 'explorer.exe')"
# cursor.execute(query)
# con.commit()
...
# for adding a manual contact after adding in mobile.
...
# Command for removing any id from database
